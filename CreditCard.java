...
//New methods on are lines 107 and 118
/*
...
public class CreditCard {
    ...
    public void makePayment(double amount) {            // make a payment
        //This if, else if chain will check to see if an amount is less than 0 or 0
        if (amount > 0 ) {
            balance -= amount;


        }
        else if (amount < 0|| amount == 0) { //This line checks to make sure the amount is valid
            System.out.print("\nInvalid Payment Amount: Payment Denied");
        }
    }
    public void changeAccountNumber(String newNumber) { //this will set an account number to a new number
        account = newNumber; //This line changes an account number based on input
        System.out.print("The new Account Number is " + newNumber);
    ...
    public static void main(String[] args) {
        ...
        wallet[0].changeAccountNumber("0000-1111-2222-3333");

        wallet[0].makePayment(-100.0);
        }
    }
}
